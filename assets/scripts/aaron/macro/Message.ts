...
export const MESSAGES = {
  ...
  WEBSOCKET: {
    ...
    PING_CONNECTION_SUCCESS: '连接活性检测成功',
    ...
    ERROR_CODE_13: '连接未打开',
    ERROR_CODE_14: 'Ping 超时',
    ERROR_CODE_15: '连接已关闭，未发送的请求已丢弃',
    ERROR_CODE_16: 'WebSocket 连接已断开，尝试重连...',
    ERROR_CODE_17: '检测连接时发生错误:',
    ERROR_CODE_18: '无法重连：目标地址未设置',
    ERROR_CODE_19: '尝试重新连接...',
    ERROR_CODE_20: '重连成功',
    ERROR_CODE_21: '重连失败:',
    ERROR_CODE_22: '连接检测失败:',
  },
} as const;
